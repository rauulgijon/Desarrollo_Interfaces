...
namespace Examen1_AsierCarreteroMillán_2.persistence
{
    public class DBBroker
    {
        private static DBBroker _instancia;
        private static MySql.Data.MySqlClient.MySqlConnection conexion;
        private const String cadenaConexion = "server=localhost;database=serpientes;uid=root;pwd=1234";
        ...
        public int modificar(MySqlCommand com)
        {
            int resultado;
            conectar();
            com.Connection = DBBroker.conexion;
            resultado = com.ExecuteNonQuery();
            desconectar();
            return resultado;
        }
